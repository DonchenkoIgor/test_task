                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-DELETEapi-products--id-">Remove the specified resource from storage.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-comments--product_id-">
                                <a href="#endpoints-GETapi-comments--product_id-">Display a listing of the resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-comments--product_id-">
                                <a href="#endpoints-POSTapi-comments--product_id-">Store a newly created resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-comments--comment_id-">
                                <a href="#endpoints-DELETEapi-comments--comment_id-">Remove the specified resource from storage.</a>
                            </li>
...
<div class="bash-example">
    ...
    --form "price=consequatur"\
    --form "category=consequatur"\
    --form "image=@/tmp/php1DG5O6" </code></pre></div>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>/tmp/php1DG5O6</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    --form "category=consequatur"\
    --form "image=@/tmp/phpw19v01" </code></pre></div>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>/tmp/phpw19v01</code></p>
        </div>
        </form>
...
<p>The ID of the product. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-comments--product_id-">Display a listing of the resource.</h2>
...
<span id="example-requests-GETapi-comments--product_id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/comments/3" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-GETapi-comments--product_id-">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-comments--product_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-comments--product_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-comments--product_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-comments--product_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-comments--product_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-comments--product_id-" data-method="GET"
      data-path="api/comments/{product_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-comments--product_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-comments--product_id-"
                    onclick="tryItOut('GETapi-comments--product_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-comments--product_id-"
                    onclick="cancelTryOut('GETapi-comments--product_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-comments--product_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/comments/{product_id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-comments--product_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-comments--product_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="product_id"                data-endpoint="GETapi-comments--product_id-"
               value="3"
               data-component="url">
    <br>
<p>The ID of the product. Example: <code>3</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-comments--product_id-">Store a newly created resource in storage.</h2>
...
<span id="example-requests-POSTapi-comments--product_id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-comments--product_id-">
</span>
<span id="execution-results-POSTapi-comments--product_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-comments--product_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-comments--product_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-comments--product_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-comments--product_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-comments--product_id-" data-method="POST"
      data-path="api/comments/{product_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-comments--product_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-comments--product_id-"
                    onclick="tryItOut('POSTapi-comments--product_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-comments--product_id-"
                    onclick="cancelTryOut('POSTapi-comments--product_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-comments--product_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-comments--product_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-comments--product_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="product_id"                data-endpoint="POSTapi-comments--product_id-"
               value="3"
               data-component="url">
    <br>
<p>The ID of the product. Example: <code>3</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="content"                data-endpoint="POSTapi-comments--product_id-"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 1000 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-comments--comment_id-">Remove the specified resource from storage.</h2>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the comment. Example: <code>2</code></p>
            </div>
                    </form>
...
<div class="bash-example">
    ...
    \"quantity\": 45,
    \"purchase_date\": \"2025-06-03T11:20:40\"
}"
</code></pre></div>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="quantity"                data-endpoint="POSTapi-purchases"
               value="45"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="purchase_date"                data-endpoint="POSTapi-purchases"
               value="2025-06-03T11:20:40"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2025-06-03T11:20:40</code></p>
        </div>
        </form>
